...
git repositories.
* But we plan to extend this to other publicly available git providers.
...
* We will be adding an API for other to build upon that will include all
information about packages, including access/download statistics.
* Make the source for the tools and services available for contributions.
